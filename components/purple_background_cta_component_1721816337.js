...
Vue.component("purple_background_cta_component_1721816337", {
    template: `
        ...
        <div id="section-container" class="max-w-6xl mx-auto px-4 sm:px-6 bg-white">
            <div id="content-container" class="relative px-8 py-12 md:py-20 rounded-[3rem] overflow-hidden">
                ...
                <div id="content" class="max-w-3xl mx-auto text-center">
                    ...
                    <div class="flex" id="content-body-container"><p id="content-body" class="flex-1 text-lg mb-8" :class="[contentBodyStyle]">Gain valuable insights into the latest Ethereum transactions with our powerful analytics platform. Monitor, track, and analyze new transactions as they occur on the Ethereum blockchain.</p></div>
