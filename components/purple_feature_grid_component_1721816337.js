...
Vue.component("purple_feature_grid_component_1721816337", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            ...
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm" :class="textPrimaryStyle">Stay ahead of the game with our cutting-edge Ethereum transaction analysis tool. Monitor new transactions as they occur, giving you a competitive edge in the ever-evolving crypto market.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            ...
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm" :class="textPrimaryStyle">Gain valuable insights into Ethereum transactions with our advanced analysis capabilities. Uncover hidden patterns, identify potential risks, and make informed decisions based on comprehensive data.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            ...
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm" :class="textPrimaryStyle">Tailor your experience by setting up custom alerts and notifications for specific transaction types or patterns. Never miss a crucial development in the Ethereum network.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            <div id="feature-4-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-4-title-container"><h4 id="feature-4-title" class="flex-1 font-medium" :class="textSecondaryStyle">Seamless Integration with Existing Tools</h4></div>
            </div>
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm" :class="textPrimaryStyle">Our transaction analysis solution integrates seamlessly with your existing Ethereum tools and workflows, ensuring a smooth and efficient experience from start to finish.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            ...
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm" :class="textPrimaryStyle">Built on a robust and secure infrastructure, our platform ensures the utmost protection for your data and analyses, giving you peace of mind in the crypto domain.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            <div id="feature-6-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-6-title-container"><h4 id="feature-6-title" class="flex-1 font-medium" :class="textSecondaryStyle">Expert Support and Community Resources</h4></div>
            </div>
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm" :class="textPrimaryStyle">Benefit from our knowledgeable support team and access a wealth of community resources, including guides, tutorials, and best practices for maximizing the value of our Ethereum transaction analysis tool.</p></div>
        </div>
    </div>`,
        data() {
            return {
