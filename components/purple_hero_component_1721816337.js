...
Vue.component("purple_hero_component_1721816337", {
    template: `
        ...
        <div id="section-container" class="relative max-w-6xl mx-auto px-4 sm:px-6 bg-white">
            <div id="hero-content-container" class="pt-32 pb-16 md:pt-52 md:pb-32">
                ...
                <div id="hero-content" class="max-w-3xl mx-auto text-center" style="position: relative;z-index: 1">
                    ...
                    <div class="flex" id="sub-hero-text-container"><p id="sub-hero-text" class="flex-1 text-lg mb-8" data-aos="fade-down" data-aos-delay="200" :class="landingPageSubHeroTextStyle">Gain valuable intelligence on new Ethereum transactions with our advanced analytics suite. Identify opportunities and risks instantly.</p></div>
